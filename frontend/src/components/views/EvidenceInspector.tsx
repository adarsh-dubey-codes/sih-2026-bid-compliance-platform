...
export const EvidenceInspector: React.FC<EvidenceInspectorProps> = ({
  ...
  const handleExecuteOfficerOrder = () => {
    if (!officerPin || officerPin.length < 4) {
      onShowToast('Please enter your 6-Digit Officer PIN to authenticate order.');
      return;
    }

    const msg =
      officerDecision === 'clarify'
        ? 'Dispatched 48-Hour GeM Statutory Clarification Notice to Bidder.'
        : officerDecision === 'reject'
        ? 'Technical Disqualification Order recorded for Clause 4.1.'
        : 'Officer Overrule recorded with mandatory justification note.';
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6 max-w-7xl mx-auto font-sans">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-[14px] text-[#66627A] mt-1">
            Split-screen document verification and deterministic OCR evaluation.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            onClick={() => {
              ...
              onShowToast(isFlagged ? 'Flag removed.' : 'Discrepancy flagged on document.');
            }}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            >
              <div className="flex items-start justify-between pb-3 border-b border-[#E5E2EC]">
                <div>
                  ...
                  <div className="text-[10px] text-[#66627A] uppercase">Government of India Maharatna Undertaking</div>
                </div>
              ...
              <div className="p-3 bg-[#FEF2F2] border border-[#FECACA] rounded-lg space-y-1.5">
                ...
                <p className="text-[13px] text-[#17152B] leading-relaxed">
                  ...
                  for 142.8 KM gas trunkline expansion project.
                </p>
              ...
              <p className="text-[12px] text-[#66627A] leading-relaxed">
                Total continuous contract period: 4.2 continuous years (Jan 2020 - Mar 2024). Operational performance met API 1104 standards.
              </p>
              ...
              <div className="pt-4 border-t border-[#E5E2EC] flex items-end justify-between text-[11px]">
                ...
                <div className="text-right">
                  ...
                  <div className="text-[10px] font-data text-[#66627A]">SAP ID: GAIL-EMP-88201</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Right Pane (5 cols): Intelligence Panel */}
        <div className="lg:col-span-5 space-y-4">
          ...
          <div className="bg-white border border-[#E5E2EC] rounded-xl p-5 space-y-3">
            ...
            <div className="bg-[#F8F9FC] p-3 rounded-lg border border-[#E5E2EC] font-data text-[11px] space-y-1 text-[#17152B]">
              <div className="text-[#66627A]">// Mathematical Formula Evaluation</div>
          ...
          <div className="bg-white border border-[#E5E2EC] rounded-xl p-5 space-y-4">
            ...
            <div className="space-y-2 text-[12px]">
              <label className="flex items-center gap-2 p-2.5 rounded-lg border border-[#E5E2EC] bg-[#F8F9FC] cursor-pointer hover:border-[#4527A0]">
                ...
                />
                <span className="text-[#17152B] font-medium">Issue 48-Hour Statutory Notice (Seek M&A Proof)</span>
              </label>
